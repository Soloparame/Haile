    ...
    en: {
        ...
        servicesList: [
            ...
            },
            {
                id: 5,
                title: 'Connections',
                description: 'We help your different computer programs talk to each other.',
                icon: '🔌',
            },
            {
                id: 6,
        ...
        servicesList: [
            {
                id: 1,
                title: 'ድረ-ገጾች',
                description: 'ጥሩ የሚመስሉ እና በኮምፒተሮች እና በስልኮች ላይ በደንብ የሚሰሩ ድረ-ገጾችን እንሰራለን።',
                icon: '🌐',
            },
            {
                id: 2,
                title: 'የሞባይል መተግበሪያዎች',
                description: 'ለ iPhone እና ለ Android ስልኮች ለመጠቀም ቀላል የሆኑ መተግበሪያዎችን እንገነባለን።',
                icon: '📱',
            },
            {
                id: 3,
                title: 'ዲዛይን',
                description: 'ለደንበኞችዎ ውብ እና ለመጠቀም ቀላል የሆኑ በይነገጾችን እንነድፋለን።',
                icon: '🎨',
            },
            {
                id: 4,
                title: 'የደመና ማከማቻ',
                description: 'ፋይሎችዎን ከየትኛውም ቦታ ሆነው ማግኘት እንዲችሉ በኢንተርኔት ላይ በደህና እንዲያስቀምጡ እናግዝዎታለን።',
                icon: '☁️',
            },
            {
                id: 5,
                title: 'ግንኙነቶች',
                description: 'የተለያዩ የኮምፒዩተር ፕሮግራሞችዎ እርስ በርስ እንዲግባቡ እናግዛለን።',
                icon: '🔌',
            },
            {
                id: 6,
                title: 'ጥገና',
                description: 'ድረ-ገጽዎ እና መተግበሪያዎችዎ ያለችግር እንዲሰሩ እናደርጋለን።',
                icon: '⚙️',
            },
        ]
    },
